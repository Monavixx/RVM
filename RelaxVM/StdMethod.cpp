...
StdMethod::StdMethod(const QString& name, const QString& dataType, const QString& nameClass, const QList<Parameter>& parameters, std::function<void(Stack&)> code, const AccessModifier& accessModifier, bool isStatic)
