...
{
    /// <summary>
    /// Класс для вывода текста в консоль. Отличие от iostream в том, что поддерживается unicode.
    /// </summary>
    ...
    /// <summary>
    /// Класс для ввода текста из консоли. Отличие от iostream в том, что поддерживается unicode.
    /// </summary>
