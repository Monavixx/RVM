...
int main()
{
    ...
    ds << quint8(4) << quint8(1) << quint8(1) << QString("void").toUtf8() << QString("NameMainClass").toUtf8() << QString("Main").toUtf8() << int(0) << int(136);
    ds << quint8(7) << QString("Hello ñorld").toUtf8();
